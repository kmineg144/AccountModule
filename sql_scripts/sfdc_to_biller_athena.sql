...
FROM BI_MIP.dbo.sfdc_to_biller_dyao b
...
drop table BI_MIP.dbo.biller_sfdc_accounts_dyao;
...
--select count(distinct family_id) from BI_MIP.dbo.biller_sfdc_accounts_dyao where sfdc_account is not NULL
...
--select * from BI_MIP.dbo.sfdc_to_biller_dyao where ACCOUNT__C ='001A000000maROMIA2'
...
UPDATE BI_MIP.dbo.biller_sfdc_accounts_dyao 
SET parent_id = b.parent_id, sfdc_account = b.sfdc_account, owner_id = b.owner_id, 
	...
	sfdc_nat_sp_ind = b.sfdc_nat_sp_ind
FROM #temp2 b
WHERE BI_MIP.dbo.biller_sfdc_accounts_dyao .family_id = b.family_id 
and concat(BI_MIP.dbo.biller_sfdc_accounts_dyao .distinct_loc_id, BI_MIP.dbo.biller_sfdc_accounts_dyao .sv_account, BI_MIP.dbo.biller_sfdc_accounts_dyao .sv_root_account, BI_MIP.dbo.biller_sfdc_accounts_dyao .csg_account) = concat( b.distinct_loc_id, b.sv_account,BI_MIP.dbo.biller_sfdc_accounts_dyao .sv_root_account, b.csg_account) 
and b.sfdc_account is not NULL and BI_MIP.dbo.biller_sfdc_accounts_dyao .sfdc_account is NULL
...
select * from  BI_MIP.dbo.biller_sfdc_accounts_dyao tablesample(1 percent)

select 
count(*)
,sum(case when sfdc_account is NULL then 0 else 1 end)
from BI_MIP.dbo.biller_sfdc_accounts_dyao 
