...
MAX(CASE WHEN SV_LINE_OF_BUSINESS = 'Broadband Commuter Service' then 'Y'
	...
	GETDATE() LOAD_DT
INTO RptCB.Rpt.SCA_MODULE_STAGE1sv_biller_mrc_loc_11_2020 --- 530058 rows ---- was 523941 rows when not including lots  --- select distinct SV_LINE_OF_BUSINESS
...
CREATE NONCLUSTERED INDEX ix_SCA_MODULE_STAGE1sv_biller_mrc_loc1 ON RptCB.Rpt.SCA_MODULE_STAGE1sv_biller_mrc_loc_11_2020(ROOT_ACCOUNT_NUMBER,ACCT_NUM,AANCUT) 
--CREATE CLUSTERED INDEX ix_SCA_MODULE_STAGE1sv_biller_mrc_loc2 ON RptCB.Rpt.SCA_MODULE_STAGE1sv_biller_mrc_loc_11_2020(AAN4,SV_EXCL_IND) 


ALTER TABLE RptCB.Rpt.SCA_MODULE_STAGE1sv_biller_mrc_loc_11_2020 ADD SV_EXCL_IND VARCHAR(1); 
...
from RptCB.Rpt.SCA_MODULE_STAGE1sv_biller_mrc_loc_11_2020 as a 


SELECT
	*
INTO RptCB.Rpt.SCA_MODULE_STAGE1sv_biller_mrc_loc_dyao_11_2020
FROM
(
SELECT 
	ROOT_ACCOUNT_NUMBER	
...
CREATE NONCLUSTERED INDEX ix_SCA_MODULE_STAGE1sv_biller_mrc_loc1 ON RptCB.Rpt.SCA_MODULE_STAGE1sv_biller_mrc_loc_dyao_11_2020(ROOT_ACCOUNT_NUMBER,ACCT_NUM,AANCUT) 
CREATE CLUSTERED INDEX ix_SCA_MODULE_STAGE1sv_biller_mrc_loc2 ON RptCB.Rpt.SCA_MODULE_STAGE1sv_biller_mrc_loc_dyao_11_2020(AAN4,SV_EXCL_IND) 

alter table RptCB.Rpt.SCA_MODULE_STAGE1sv_biller_mrc_loc_dyao_11_2020 drop column SVM_BUSN_ID, SVM_HQ_ID,SVAN_BUSN_ID ,SVAN_HQ_ID ,CSG_BUSN_ID ,CSG_HQ_ID 
ALTER TABLE RptCB.Rpt.SCA_MODULE_STAGE1sv_biller_mrc_loc_dyao_11_2020 add SVM_BUSN_ID BIGINT,SVM_HQ_ID BIGINT,SVAN_BUSN_ID BIGINT,SVAN_HQ_ID BIGINT,CSG_BUSN_ID BIGINT,CSG_HQ_ID BIGINT
...
INTO
	#UPDATESVMBUSNID	
FROM
	rptCB.Rpt.SCA_MODULE_STAGE1sv_biller_mrc_loc_dyao_11_2020 a
left join
...
UPDATE RptCB.Rpt.SCA_MODULE_STAGE1sv_biller_mrc_loc_dyao_11_2020 
...
--select top 100000  root_account_number, acct_num,SV_ACCT_ADDR1 ,SVM_BUSN_ID, SVM_HQ_ID,SVAN_BUSN_ID ,SVAN_HQ_ID ,CSG_BUSN_ID ,CSG_HQ_ID from RptCB.Rpt.SCA_MODULE_STAGE1sv_biller_mrc_loc_dyao_11_2020  -- where CSG_BUSN_ID is NOT NULL
...
select top 10000 * from RptCB.Rpt.SCA_MODULE_STAGE1sv_biller_mrc_loc_dyao_11_2020 



drop table RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020
...
INTO RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020
FROM RptCB.Rpt.SCA_MODULE_STAGE1sv_biller_mrc_loc_dyao_11_2020
...
DROP INDEX ix_SCA_MODULE_STAGE1Xa on RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 
create nonclustered index ix_SCA_MODULE_STAGE1Xa on RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 (SV_ROOT_ACCOUNT,SV_ACCOUNT,CSG_ACCOUNT)

DROP INDEX ix_SCA_MODULE_STAGE1Xb on RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 
create nonclustered index ix_SCA_MODULE_STAGE1Xb on RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 (CSG4,CSG_ACCOUNT,CSG_HOUSEKEY,CSG_DWELL_CODE)

DROP INDEX ix_SCA_MODULE_STAGE1Xc on RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 
create nonclustered index ix_SCA_MODULE_STAGE1Xc on RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 (FILE_GROUP,CSG_BUSN_ID,CSG_HQ_ID,SVM_BUSN_ID,SVM_HQ_ID,SVAN_BUSN_ID,SVAN_HQ_ID) --FAMILY_ID


--select  * from RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 tablesample(1 percent)  -- where CSG_BUSN_ID is NOT NULL
...
UPDATE RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 
...
INSERT INTO RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020
SELECT 
GETDATE() LOAD_DT,
1111111111111111 FAMILY_ID,
'CSG' FILE_GROUP,
...
AND ACCOUNT_NUMBER NOT IN ( SELECT DISTINCT CSG_ACCOUNT FROM RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020  WITH (NOLOCK) WHERE CSG4  in ('8155','8777','8497','8498','8772','8778','8495','8512')  AND CSG_ACCOUNT IS NOT NULL )--- 117343
...
ALTER TABLE RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 ALTER COLUMN CSG_CONNPRO_MRC_WD NUMERIC(15,2); 
ALTER TABLE RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 ALTER COLUMN CSG_WIFIPRO_MRC_WD NUMERIC(15,2);  
ALTER TABLE RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 ALTER COLUMN CSG_SECEDGE_MRC_WD NUMERIC(15,2);  
...
ALTER TABLE RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 ALTER COLUMN [CSG_OTHER_MRC_BCS] NUMERIC(15,2); 
ALTER TABLE RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 ALTER COLUMN [CSG_TOTAL_MRC_BCS_WD] NUMERIC(16,3);  

UPDATE A
SET [CSG_OTHER_MRC_BCS] = [CSG_TOTAL_MRC_BCS] - ([CSG_VOICE_MRC]+[CSG_DATA_MRC]+[CSG_VIDEO_MRC]+[CSG_CONNPRO_MRC_BCS]+[CSG_OTHER_MRC_BCS])
FROM RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 as A
...
ALTER TABLE RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020  ADD SITE_TOTAL_MRC NUMERIC(15,2)
...
ALTER TABLE RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020  ADD CSG_HBB_IND VARCHAR(1) ;
...
from(
	...
	FROM RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 as x
...
ALTER TABLE RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020
ADD 
...
------- DO NOT RUN UNTIL FAMILY_IDs ARE CREATED---------


update RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 
set FAMILY_ID = _FinalFamilyID_
from RPTCB.RPT.FAMILY_ID_YAO AS F --- this is the table RAM created from his SAS script
where  [DISTINCT_LOC_ID] = F._DISTINCT_LOC_ID_ and FAMILY_ID = 0


;WITH FIELD_GROUP_ALTERED_BY_FAMILY AS(
SELECT DISTINCT FAMILY_ID FAMILY_IDjoin FROM RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020  WHERE FILE_GROUP = 'SV+CSG' )
update RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 
...
ALTER TABLE  RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020  ADD FAMILY_ID_REGION VARCHAR(50);
SELECT family_id,DISTINCT_LOC_ID,CSG_BUSN_ID	,CSG_HQ_ID,	SVM_BUSN_ID,	SVM_HQ_ID,	SVAN_BUSN_ID,	SVAN_HQ_ID INTO #CKFAM_REGION FROM RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 WHERE FAMILY_ID_REGION IS  NULL
...
FROM RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 WHERE SVM_HQ_ID IS NOT NULL
--and FAMILY_ID in (select family_id from #CKFAM_REGION) --and family_id_region is not null
UNION ALL
SELECT DISTINCT 
FAMILY_ID,SVAN_HQ_ID, DISTINCT_LOC_ID
FROM RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 WHERE SVAN_HQ_ID IS NOT NULL
---and FAMILY_ID in (select family_id from #CKFAM_REGION) --and family_id_region is not null
UNION ALL
SELECT DISTINCT
FAMILY_ID,COALESCE(CSG_HQ_ID,CSG_BUSN_ID,CSG_ACCOUNT) SD , DISTINCT_LOC_ID
FROM RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 WHERE CSG_ACCOUNT IS NOT NULL
---and FAMILY_ID in (select family_id from #CKFAM_REGION) --and family_id_region is not null
) AS B
...
FROM (  
  ...
  FROM
    RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020 AS A WITH (NOLOCK)
...
where RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020.CSG_BUSN_NAME = b.CSG_BUSN_NAME  and SV_ACCOUNT IS NULL
  ---- 290252
...
where RptCB.Rpt.SCA_MODULE_STAGE1X_DYAO_11_2020.SV_ROOT_ACCOUNT_NAME = b.SV_ROOT_ACCOUNT_NAME  
  ---- 2902
