...
--drop table rptcb.rpt.biller_sfdc_accounts_summary_dyao_11_2020
...
SELECT 
	...
	max(TRY_CAST(SV_ACCT_ZIP AS INT)) as BILLING_ZIP_MAX,
...
FROM rptcb.rpt.biller_sfdc_accounts_summary_dyao_11_2020 AS A --601395
...
ESTIMATED_FAMILY_SPEND_RANGE = 
			CASE WHEN COALESCE(FAMILY_SPEND_EST_FOR_EVAL,0) BETWEEN   -1 AND  100 THEN  '100 OR LESS'
				 ...
				 ELSE '4000+' END
FROM rptcb.rpt.biller_sfdc_accounts_summary_dyao_11_2020 AS A

update a
set ESTIMATED_FAMILY_MODULE = 'EXCLD'--- SELECT COUNT(*) CNT
from rptcb.rpt.biller_sfdc_accounts_summary_dyao_11_2020 as a where --family_id = 35161	AND --- 10658
...
------Run this to get the summary.csv for python

select * from rptcb.rpt.biller_sfdc_accounts_summary_dyao_11_2020 order by family_id
